...
class GatewayManagerEMQX:
    ...
    def create_gateway_user(self, gateway_id: str, discord_user: Union[User, Member]) -> tuple[GatewayData, str]:
        ...
        try:
            ...
            self.emqx.create_user_authorization_rules_built_in_database(gateway.user_string, mqtt_rules)
        except HTTPError as e:
            raise GatewayAlreadyExists(f"Gateway already exists: {e}", gateway)
